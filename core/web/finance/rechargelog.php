...
class Rechargelog_ChingLeeingPage extends WebPage
{
    function main($type = 1)
    {
        ...
        $sql = 'select * from ' . tablename('ching_leeing_member_log') .' where 1 and datatype = 1' . $condition . ' ORDER BY createtime DESC ';
        ...
        $total = pdo_fetchcolumn('select count(*) from ' . tablename('ching_leeing_member_log') . ' where datatype = 1'  . $condition . ' ', $params);
