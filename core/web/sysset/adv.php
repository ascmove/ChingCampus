...
class Adv_ChingLeeingPage extends WebPage
{
    ...
    protected function post()
    {
        ...
        if ($_W['ispost']) {
            $data = array('uniacid' => $_W['uniacid'], 'advname' => trim($_GPC['advname']), 'link' => trim($_GPC['link']), 'enabled' => intval($_GPC['enabled']),  'thumb' => save_media($_GPC['thumb']));
            ...
            show_json(1, array('url' => webUrl('sysset/adv')));
        }
